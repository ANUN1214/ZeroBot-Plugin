...
import (
	...
	_ "github.com/FloatTech/ZeroBot-Plugin/console" // 更改控制台属
...
func init() {
	...
	url := flag.String("u", "ws://127.0.0.1:4001/ws", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "ANUN", "Set default nickname.")
